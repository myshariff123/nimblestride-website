          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                osfi: 's. 5',
                desc: '7-question OSFI s. 5 checklist for every third-party and vendor model. AI deep-dive analysis generates compliance score, critical gaps, remediation plan, and concentration risk.',
                features: ['Structured s. 5 checklist per vendor model', 'AI vendor risk deep dive (Bedrock Sonnet)', 'Concentration risk and trend analysis'],
              },
              {
                ...
                features: ['DB-level append-only enforcement', 'Paginated, filterable audit log', 'Satisfies OSFI E-23 s. 4.4 immutability requirement'],
              },
              {
              ...
              },
              {
                ...
                osfi: 's. 4.2',
                desc: 'Version history with AI materiality assessment per OSFI s. 4.2. Derived validation schedules with AI weekly CRO briefing. Exam Sprint Mode: AI-generated 30/60/90-day action plans.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { model: 'Sonnet', title: 'Findings Analyzer', desc: 'Severity rating, OSFI section references, completeness score, approval recommendation.' },
              { model: 'Sonnet', title: 'Approval Readiness Check', desc: 'Verifies all E-23 requirements are met before the approver signs off.' },
              { model: 'Sonnet', title: 'Vendor s. 5 Deep Dive', desc: 'OSFI s. 5 compliance score, critical gaps, remediation plan, concentration risk.' },
              ...
              { model: 'Sonnet', title: 'Risk Appetite Statement', desc: '6-question MRA Wizard → AI-generated board-approved Risk Appetite Statement (OSFI s. 3.1).' },
              { model: 'Haiku', title: 'Materiality Assessment', desc: 'AI materiality check on every model change — satisfies OSFI s. 4.2 change management.' },
